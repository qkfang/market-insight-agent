...
public sealed class MarketResearchAgent : BaseAgent
{
    private const string AgentInstructions = """
        ...
        1. Call read_news_analysis_by_market with the market name, weekStart and weekEnd to get related news analysis articles filtered to the date range.
        2. Call bing_search_market with the market name, weekStart and weekEnd to get current Bing news results for that date range.
