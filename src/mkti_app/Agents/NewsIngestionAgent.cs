...
public sealed class NewsIngestionAgent : BaseAgent
{
    private const string AgentInstructions =
        "You are a news ingestion agent for copper market. Ingest from the local mock dataset file articles-xx.json and store each article object unchanged in the news store. " +
